...
const FrictionlessC0de = {
  ...
  weapons   : ["React", "Node.js", "TypeScript", "PostgreSQL"],
  training  : ["Go", "Cloud Architecture", "System Design"],
  rivals    : ["Bugs", "Deadlines", "Scope Creep"],
  status    : "⚔️  Available for quests"
};
```
